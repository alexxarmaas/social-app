...
export default function AdminRoutesManager({ initialRoutes }: AdminRoutesManagerProps) {
  ...
  return (
    <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
      <div className="rounded-[2rem] border border-zinc-800 bg-zinc-950/80 p-5 shadow-[0_25px_80px_rgba(0,0,0,0.35)]">
        <div className="mb-5 flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-semibold text-zinc-50">Inventario de rutas</h2>
          </div>
      ...
      <form onSubmit={handleSubmit(saveRoute)} className="rounded-[2rem] border border-zinc-800 bg-zinc-950/80 p-5 shadow-[0_25px_80px_rgba(0,0,0,0.35)]">
        <div className="mb-5">
          <p className="text-[10px] uppercase tracking-[0.45em] text-zinc-500">Crear / editar</p>
          <h2 className="mt-2 text-2xl font-semibold text-zinc-50">Formulario de ruta</h2>
        </div>
