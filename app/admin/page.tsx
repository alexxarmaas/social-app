...
export default async function AdminPage() {
  ...
  return (
    <div className="mx-auto max-w-[98rem] space-y-7">
      <header className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-6 shadow-[0_25px_80px_rgba(0,0,0,0.25)]">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl space-y-3">
            <p className="text-[10px] uppercase tracking-[0.45em] text-zinc-500">Panel</p>
            <h2 className="font-sans text-3xl font-semibold tracking-tight text-white md:text-5xl">Centro de control de contenido</h2>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="rounded-[1.5rem] border border-zinc-800 bg-zinc-900/60 p-5">
          ...
          <p className="mt-3 font-sans text-2xl font-semibold text-white">Cloudinary</p>
          <p className="mt-2 text-xs text-zinc-500">Subida firmada</p>
        </div>
      </div>
