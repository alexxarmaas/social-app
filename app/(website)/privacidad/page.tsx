  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-5 py-16 text-zinc-300">
      ...
      <div className="mt-8 space-y-5 leading-7">
        ...
        <p>Si aceptas anuncios, Google AdSense puede almacenar o leer identificadores en tu dispositivo. Puedes rechazarlo desde el aviso mostrado en la web y borrar la preferencia eliminando los datos locales del sitio.</p>
