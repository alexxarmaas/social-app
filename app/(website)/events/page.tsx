    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-50">
      <section className="mx-auto max-w-7xl px-5 py-14 lg:px-8">
        <div className="max-w-3xl space-y-4">
          ...
          <h1 className="text-4xl font-black uppercase tracking-[0.12em] text-white md:text-6xl">Eventos oficiales de Tramassso</h1>
              ...
              <article className="group overflow-hidden rounded-[2rem] border border-zinc-800 bg-zinc-950/80">
                <div className="relative aspect-[16/11] overflow-hidden bg-zinc-900">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    <p className="text-[10px] uppercase tracking-[0.45em] text-zinc-400">{new Date(event.date).toLocaleDateString("es-ES")}</p>
