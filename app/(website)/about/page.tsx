            ...
            <main className="container mx-auto px-4 py-12 sm:py-20">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-6 text-base leading-7 text-slate-300 sm:space-y-8 sm:text-lg">
                        <p>
                            Tramassso es la plataforma social definitiva para entusiastas del motor. Reunimos a amantes del automovil de todo el mundo para compartir sus proyectos, conectar con personas afines y celebrar la cultura automotriz.
                        </p>
                        ...
                        <div className="rounded-2xl border border-slate-700 bg-slate-800/50 p-5 backdrop-blur-sm sm:p-8">
                            ...
                            <p className="text-slate-300">
                                Crear la plataforma mas completa y atractiva para entusiastas del motor, donde cada miembro pueda mostrar su pasion, aprender de otros y participar en la vibrante comunidad automotriz.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700">
                                ...
                                <p className="text-slate-400">
                                    Pasion, comunidad, autenticidad y respeto por todas las culturas y preferencias automotrices.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl bg-gradient-to-r from-red-500 to-orange-500 p-5 text-white sm:p-8">
                            ...
                            <p className="mb-6">
                                Ya sea que te gusten los JDM, el lujo europeo, el muscle americano o los vehiculos electricos, Tramassso es tu hogar. ¡Unete a miles de entusiastas hoy!
                            </p>
